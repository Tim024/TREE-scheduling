...
//PHY_POWER_3dBm PHY_POWER_m7dBm
#endif
#ifndef RF2XX_RX_RSSI_THRESHOLD
#define RF2XX_RX_RSSI_THRESHOLD  RF2XX_PHY_RX_THRESHOLD__m101dBm
//RF2XX_PHY_RX_THRESHOLD__m101dBm RF2XX_PHY_RX_THRESHOLD__m60dBm
#endif
...
get_value(radio_param_t param, radio_value_t *value)
{
  ...
  case RADIO_CONST_MAX_PAYLOAD_LEN:
    *value = (radio_value_t) RF2XX_MAX_PAYLOAD;
    return RADIO_RESULT_OK;
